...
<html lang="en">
    ...
    <%
        ...
        ResultSet rs = st.executeQuery("SELECT * FROM tbl_students WHERE student_department='"+department+"'");
                ...
                <div class="row">
                    ...
                    <div class="span9">
                        <div class="content">
                            ...
                            <div class="module">
                                <!--<button class="btn btn-success pull-right" data-toggle="modal" data-target="#studentModal">Add New Student</button>--> 
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped display"
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center">
                                                    <%=rs.getString("student_rfid")%>
                                                </td>
                                                  <td class="center">
                                                  <a href="view_attendance.jsp?id=<%=rs.getString("student_rfid")%>"  title="View Attendance" class="text-info"><i class="menu-icon icon-eye-open"></i></a>
                                                </td>
                                            </tr>
                                            <%
                                                }
                    ...
                    <form action="AddStudent">
                        <div class="modal-body">
                            <div class="form-control">
                                ...
                                <select name="rfid" id="rfid" class="controls row-fluid" required>
                                    <option value="">Select RFID</option>
                                    <%
                                        String sql = "SELECT * FROM tbl_rfid WHERE rfid_status=0";
                                        rs = st.executeQuery(sql);
                                        while (rs.next()) {
                                    %>
                                    <option value="<%=rs.getString("rfid")%>"><%=rs.getString("rfid")%></option>
                                    <%
                                        }
                                        rs.close();
                                        st.close();
                            ...
                            <div class="form-control">
                                ...
                                <input type="text" required="" class="controls row-fluid" id="student_name" name="student_name">
                            </div>
                            <div class="form-control">

...
public class AddSubject extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "SELECT * from tbl_subjects WHERE subject_name='" + name + "' and department='" + department + "' and year='" + year + "'";
            ...
            if (rs.next()) {
                ...
                sql = "INSERT INTO tbl_subjects(subject_name,year,department) "
                        + "VALUES('" + name + "','" + year + "','" + department + "')";
